        ...
        <div className="px-4 py-4 sm:py-20 z-50">
          <div id="about" className="sm:container overflow-x-hidden">
            ...
            <motion.span
              ...
              >
                PENGENALAN <span className="font-normal">TENTANG</span>
              </motion.span>
              <motion.span
                initial={{ x: -100, opacity: 0 }}
                whileInView={{ x: 0, opacity: 1 }}
              ...
              >
                <span className='font-bold text-[#1dbbb4]'>EKONOMI MYANMAR</span>
              </motion.span>
            </h1>
            <div
              className="max-w-[800px] mx-auto p-6 sm:px-8 sm:py-12 rounded-md bg-white border border-gray-600 mt-4 md:[90px] lg:mt-[120px]"
            >
              <h1 className="text-xl sm:text-2xl tracking-widest uppercase font-bold">MYANMAR</h1>
              <p className="sm:text-lg max-w-2xl mt-4 mb-6 text-left sm:text-justify">
              Myanmar merupakan negara berkembang yang ada di ASEAN. Perekonomian negara Myanmar masih dalam proses reformasi setelah melewati beberapa pemerintahan sebelumnya. Pertanian merupakan tulang punggung dari ekonomi Myanmar saat ini seperti hasil padi, karet, jagung dan teh. Di samping pertumbuhan ekonomi, kemiskinan masih menjadi masalah serius yang ada di Myanmar. Dalam 3 tahun terakhir inflasi perekonomian yang terjadi mencapai angka 16,2%. Hal itu berimbas dari pertumbuhan ekonomi yang belum stabil dan proses reformasi yang masih dilakukan.
        ...
        <div  className="relative mt-10 xl:mt-40 border-4 border-[#0C7C95] w-[250px] h-[230px] sm:w-[395px] sm:h-[377px] xl:w-[595px] xl:h-[477px] bg-white z-[1]">
          <div>
            <div className="absolute -top-5 sm:-top-10 -left-5 sm:-left-10 z-0">
              ...
              <img src="https://i.ibb.co.com/L9f1hQ7/myanmar.webp" alt="bg-vector" className="object-cover h-full" />
              </div>
            </div>
          </div>
        </div>
...
export default PengenalanMyanmar;
