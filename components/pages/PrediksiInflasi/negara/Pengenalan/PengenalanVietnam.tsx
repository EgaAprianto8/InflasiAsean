        ...
        <div className="px-4 py-4 sm:py-20 z-50">
          <div id="about" className="sm:container overflow-x-hidden">
            ...
            <motion.span
              ...
              >
                <span className='font-bold text-[#1dbbb4]'>EKONOMI VIETNAM</span>
              </motion.span>
            </h1>
            <div
              className="max-w-[800px] mx-auto p-6 sm:px-8 sm:py-12 rounded-md bg-white border border-gray-600 mt-4 md:[90px] lg:mt-[120px]"
            >
              <h1 className="text-xl sm:text-2xl tracking-widest uppercase font-bold">VIETNAM</h1>
              <p className="sm:text-lg max-w-2xl mt-4 mb-6 text-left sm:text-justify">
Vietnam, negara di Asia Tenggara, menunjukkan pertumbuhan ekonomi yang signifikan melalui sektor pertanian dan manufaktur yang berkembang pesat, didorong oleh investasi asing dan dukungan infrastruktur pemerintah. Sektor teknologi, layanan keuangan digital, dan pariwisata juga tumbuh pesat. Meskipun menghadapi tantangan regional dan inflasi yang diatur, Vietnam tetap fokus pada reformasi ekonomi dan investasi pendidikan, memperkuat posisinya sebagai kekuatan ekonomi yang menarik secara global.
              </p>
            </div>
          </div>
        </div>
        ...
        <div  className="relative mt-10 xl:mt-40 border-4 border-[#0C7C95] w-[250px] h-[230px] sm:w-[395px] sm:h-[377px] xl:w-[595px] xl:h-[477px] bg-white z-[1]">
          <div>
            <div className="absolute -top-5 sm:-top-10 -left-5 sm:-left-10 z-0">
              ...
              <img src="https://i.ibb.co.com/L6f9wrj/photo-1559592413-7cec4d0cae2b.jpg" alt="bg-vector" className="object-cover h-full" />
              </div>
            </div>
          </div>
        </div>
...
export default PengenalanVietnam;
