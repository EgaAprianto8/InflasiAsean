        ...
        <div className="px-4 py-4 sm:py-20 z-50">
          <div id="about" className="sm:container overflow-x-hidden">
            ...
            <motion.span
              ...
              >
                <span className='font-bold text-[#1dbbb4]'>EKONOMI INDONESIA</span>
              </motion.span>
            </h1>
            <div
              className="max-w-[800px] mx-auto p-6 sm:px-8 sm:py-12 rounded-md bg-white border border-gray-600 mt-4 md:[90px] lg:mt-[120px]"
            >
              <h1 className="text-xl sm:text-2xl tracking-widest uppercase font-bold">INDONESIA</h1>
              <p className="sm:text-lg max-w-2xl mt-4 mb-6 text-left sm:text-justify">
              Indonesia merupakan salah satu negara dengan ekonomi terbesar di Asia Tenggara. Perekonomian Indonesia didukung oleh sektor-sektor seperti pertanian, manufaktur, pertambangan, dan jasa. Adapun tingkat inflasi ekonomi Indonesia mengalami kenaikan sebesar 4,2% di tahun 2022 dan terjadi penurunan angka inflasi di tahun 2023 menjadi 3,6% dan di 2024 sebesar 2,5%. Pemerintah Indonesia masih berupaya membangun daya saing ekonomi yang ada menjadi lebih baik
              </p>
            </div>
          </div>
        </div>
        ...
        <div  className="relative mt-10 xl:mt-40 border-4 border-[#0C7C95] w-[250px] h-[230px] sm:w-[395px] sm:h-[377px] xl:w-[595px] xl:h-[477px] bg-white z-[1]">
          <div>
            <div className="absolute -top-5 sm:-top-10 -left-5 sm:-left-10 z-0">
              ...
              <img src="https://i.ibb.co.com/h9FvNy0/steffen-bertram-28jo-Uil-Higc-unsplash.jpgg" alt="bg-vector" className="object-cover h-full" />
              </div>
            </div>
          </div>
        </div>
...
export default PengenalanIndonesia;
