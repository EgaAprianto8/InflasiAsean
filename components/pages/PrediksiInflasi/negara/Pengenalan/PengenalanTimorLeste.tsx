        ...
        <div className="px-4 py-4 sm:py-20 z-50">
          <div id="about" className="sm:container overflow-x-hidden">
            ...
            <motion.span
              ...
              >
                <span className='font-bold text-[#1dbbb4]'>EKONOMI TIMOR LESTE</span>
              </motion.span>
            </h1>
            <div
              className="max-w-[800px] mx-auto p-6 sm:px-8 sm:py-12 rounded-md bg-white border border-gray-600 mt-4 md:[90px] lg:mt-[120px]"
            >
              <h1 className="text-xl sm:text-2xl tracking-widest uppercase font-bold">TIMOR LESTE</h1>
              <p className="sm:text-lg max-w-2xl mt-4 mb-6 text-left sm:text-justify">
              Timor Leste merupakan negara yang perekonomiannya masih ditahap berkembang dengan didominasi oleh sektor pertanian. Sebagian besar lain perekonomian disumbangkan ari sumber daya alam seperti minyak bumi dan gas alam. Timor leste memiliki ketergantungan pada sektor sumber daya alam, yang menjadi perhatian utama. Di 3 tahun terakhir, perekonomian inflasi di timor leste mencapai 6% - 7%. Pemerintah Timor Leste terus berupaya untuk mengatasi tantangan ini sambil mempromosikan diversifikasi ekonomi dan menciptakan lingkungan yang kondusif bagi investasi dan pertumbuhan ekonomi yang berkelanjutan.
              </p>
            </div>
          </div>
        </div>
        ...
        <div  className="relative mt-10 xl:mt-40 border-4 border-[#0C7C95] w-[250px] h-[230px] sm:w-[395px] sm:h-[377px] xl:w-[595px] xl:h-[477px] bg-white z-[1]">
          <div>
            <div className="absolute -top-5 sm:-top-10 -left-5 sm:-left-10 z-0">
              ...
              <img src="https://i.ibb.co.com/vVwQHFB/thomas-vuillemin-Hu-FL2-Vf-O41-U-unsplash.jpg" alt="bg-vector" className="object-cover h-full" />
              </div>
            </div>
          </div>
        </div>
...
export default PengenalanTimorLeste;
