        ...
        <div className="px-4 py-4 sm:py-20 z-50">
          <div id="about" className="sm:container overflow-x-hidden">
            ...
            <motion.span
              ...
              >
                <span className='font-bold text-[#1dbbb4]'>EKONOMI MALAYSIA</span>
              </motion.span>
            </h1>
            <div
              className="max-w-[800px] mx-auto p-6 sm:px-8 sm:py-12 rounded-md bg-white border border-gray-600 mt-4 md:[90px] lg:mt-[120px]"
            >
              <h1 className="text-xl sm:text-2xl tracking-widest uppercase font-bold">MALAYSIA</h1>
              <p className="sm:text-lg max-w-2xl mt-4 mb-6 text-left sm:text-justify">
              Malaysia merupakan negara yang terletak di kawasan asia tenggara. Ekonomi Malaysia adalah salah satu yang paling maju di Asia Tenggara, dengan sektor manufaktur yang kuat dan keragaman ekonomi yang signifikan. Malaysia memiliki sektor manufaktur yang berkembang pesat, terutama di produksi elekronik, otomotif, perlatan medis dan barang - barang konsumen. Di 3 tahun terakhir angka inflasi di Malaysia mencapai 2,9%. Malaysia terus berupaya untuk memperkuat fondasi ekonominya melalui kebijakan-kebijakan pro-pertumbuhan dan upaya untuk meningkatkan daya saingnya secara global.
              </p>
            </div>
          </div>
        </div>
        ...
        <div  className="relative mt-10 xl:mt-40 border-4 border-[#0C7C95] w-[250px] h-[230px] sm:w-[395px] sm:h-[377px] xl:w-[595px] xl:h-[477px] bg-white z-[1]">
          <div>
            <div className="absolute -top-5 sm:-top-10 -left-5 sm:-left-10 z-0">
              ...
              <img src="https://i.ibb.co.com/kh0k6NQ/photo-1632829426073-f12a3b459d35.jpg" alt="bg-vector" className="object-cover h-full" />
              </div>
            </div>
          </div>
        </div>
...
export default PengenalanMalaysia;
