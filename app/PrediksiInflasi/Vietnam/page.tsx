...
import PengenalanVietnam from '@/components/pages/PrediksiInflasi/negara/Pengenalan/PengenalanVietnam'
import Vietnam from '@/components/pages/PrediksiInflasi/negara/grafik/vietnam'
